...
<div class="container">
  <div class = "background-event">
    <img class="background" src = "https://imagenes.elpais.com/resizer/3GXN2nbQWqBh8zdIrzne4Ih67PE=/1960x1103/cloudfront-eu-central-1.images.arcpublishing.com/prisa/DWKOFUG3LVCLXJLULKJ4YDACSM.jpg" alt = "">
  </div>
  ...
  <div class = "comment-section">
    ...
    <div class = "comment-card">
      <div class = "descriptionDiv">
        <h3 class = "name_comment">Lucyna Kushinada &nbsp;&nbsp;</h3>
        <h4 class = "puntuación">10</h4>
      </div>
      <p class = "comment">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed pharetra ex est. Proin tempus lacus a augue feugiat, interdum pellentesque.</p>
    </div>
    <div class = "comment-card">
      <div class = "descriptionDiv">
        <h3 class = "name_comment">Lucyna Kushinada &nbsp;&nbsp;</h3>
